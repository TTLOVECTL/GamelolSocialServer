...
namespace DatabaseConnection.Database
{
    ...
    public class BaseMessageDatabase
    {
        ...
        /// <param name="playerid"></param>
        /// <returns></returns>
        public PlayerBaseMessage GetPlayerBaseMessageByPlayerName(string playerName)
        {
            PlayerBaseMessage playerBaseMessage = null;
            string get_sql = "select * from tb_playerbasemessage where playername='" + playerName+"'";
            MySqlCommand mySqlCommand = new MySqlCommand(get_sql, mySqlConnection);
            MySqlDataReader reader = null;
            try
            {
        ...
        /// <param name="playerId"></param>
        /// <param name="glodnumber"></param>
        public void UpdatePlayerAddGlodnumber(int playerId, int glodnumber)
        {
            string update_sql = "update tb_playerbasemessage set glodnumber+=" + glodnumber + " where playerid =" + playerId.ToString();
            MySqlCommand cmd = new MySqlCommand(update_sql, mySqlConnection);
            try
        ...
        /// <param name="playerId"></param>
        /// <param name="glodnumber"></param>
        public void UpdatePlayerReduceGlodnumber(int playerId, int glodnumber)
        {
            string update_sql = "update tb_playerbasemessage set glodnumber-=" + glodnumber + " where playerid =" + playerId.ToString();
            MySqlCommand cmd = new MySqlCommand(update_sql, mySqlConnection);
            try
